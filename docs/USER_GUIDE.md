...
2. Double-click **`CraneRemoteControl-2.0.0.msi`**
...
| What | Where |
|---|---|
| Installer | `crane-ui\build\jpackage\CraneRemoteControl-2.0.0.msi` |
| Portable app | `crane-ui\build\jpackage\CraneRemoteControl\` |
| Your own crane profiles | `profiles\*.json` next to the program |
| Telemetry recordings | `telemetry\*.csv` next to the program |
